...
const options = {
  scope: 'arsenal072' // 空间对象名称 
}
var config = {
  qiniu: {
    accessKey: '_rKQupj5uB1RMxa1HcBPsGNoYwYrR8CR1HyWZxPT',  // 个人中心 秘钥管理里的 AccessKey
    secretKey: 'P0RjghPXE8mUcGyMifvg6lL53XapCP8644iQCyRs',  // 个人中心 秘钥管理里的 SecretKey
    bucket: options.scope,
    domain: 'http://q87t17btt.bkt.clouddn.com/'
  }
}
