...
_axios.interceptors.request.use(
    function(config) {
        if (store.state.user.unionId) {
            config.headers.unionId = store.state.user.unionId
        }
        if (store.state.user.hospitalId) {
            config.headers.hospitalId = store.state.user.hospitalId
        }
...
const requestGet = (_url, obj) => _axios.get(_url, config)
const requestPost = (_url, obj) => _axios.post(_url, obj, config)
